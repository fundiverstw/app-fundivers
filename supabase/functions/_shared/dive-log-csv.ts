// Edge-function copy of the dive-log CSV builder. Mirror of
// src/lib/dive-log-csv.ts — keep both in sync when columns change.
// (Deno can't import across into src/.)
