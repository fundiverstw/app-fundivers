...
// Third bouncer — sexy nudibranch leads to the brick-breaker minigame.
// Kept separate from SharkBouncer / TurtleBouncer for the same reason
// the others stayed separate: each tunes its own image, palette, and
// target route, and three near-duplicates are easier to read than one
// generalized component with config props.
...
export function NudibranchBouncer() {
  ...
  return (
    ...
    >
      <img
        src="/imgs/sexy-nudibranch.jpeg"
        alt=""
        className="w-full h-full object-cover rounded-full drop-shadow-[0_0_14px_rgba(236,72,153,0.5)]"
        draggable={false}
      />
    </button>
  )
